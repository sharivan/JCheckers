...
public class ImageListImpl implements ImageList {
	...
	public ImageListImpl(String path) {
		this.path = path;
	 ...
	 * @throws IOException
	 */
	HashMap<String, Image> getImageList(Class<ImageListImpl> clazz, String path) throws URISyntaxException, IOException {
	...
	public void init() {
		...
		try {
			...
			HashMap<String, Image> map = getImageList(ImageListImpl.class, path);
