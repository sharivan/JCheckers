 ...
 * All rights reserved.
 * 
 * Derived partly from code Copyright (c) 1996 Type & Graphics Pty Limited. All
 * rights reserved.
 */
...
public class HexUtil {
	...
	public static String byteToString(int n) {
		char[] buf = { UHEXDIGITS[n >>> 4 & 0x0F], UHEXDIGITS[n & 0x0F] };
	...
	public static String intToString(int n) {
		return intToString(n, 8, false);
	}

	public static String intToString(int n, boolean upcase) {
		return intToString(n, 8, upcase);
	}

	public static String intToString(int n, int digits) {
		return intToString(n, digits, false);
	}
	 ...
	 */
	public static String intToString(int n, int digits, boolean upcase) {
	 ...
	 */
	public static String longToString(long n, boolean upcase) {
	 ...
	 */
	public static String shortToString(int n, boolean upcase) {
		char[] hexDigits = upcase ? UHEXDIGITS : LHEXDIGITS;
	...
	public static char toDigit(int n) {
		return toDigit(n, false);
	}

	/**
	 * Returns the hex digit corresponding to a number <i>n</i>, from 0 to 15.
	 */
	public static char toDigit(int n, boolean upcase) {
		char[] hexDigits = upcase ? UHEXDIGITS : LHEXDIGITS;
	...
	public static String toReversedString(byte[] b) {
		return toReversedString(b, 0, b.length, false);
	}

	public static String toReversedString(byte[] b, boolean upcase) {
		return toReversedString(b, 0, b.length, upcase);
	}

	public static String toReversedString(byte[] b, int offset, int length) {
		return toReversedString(b, offset, length, false);
	}
	 ...
	 */
	public static String toReversedString(byte[] b, int offset, int length, boolean upcase) {
	...
	public static String toString(byte[] ba) {
		return toString(ba, 0, ba.length, false);
	}

	public static String toString(byte[] ba, boolean upcase) {
		return toString(ba, 0, ba.length, upcase);
	}

	public static String toString(byte[] ba, int offset, int length) {
		return toString(ba, offset, length, false);
	}
	 ...
	 * If offset and length are omitted, the whole array is used.
	 */
	public static String toString(byte[] ba, int offset, int length, boolean upcase) {
		char[] buf = new char[length * 2];
		int j = 0;
		int k;
	...
	public static String toString(int[] ia) {
		return toString(ia, 0, ia.length, false);
	}

	public static String toString(int[] ia, boolean upcase) {
		return toString(ia, 0, ia.length, upcase);
	}
	...
	public static String toString(int[] ia, int offset, int length) {
		return toString(ia, offset, length, false);
	}
	 ...
	 * If offset and length are omitted, the whole array is used.
	 */
	public static String toString(int[] ia, int offset, int length, boolean upcase) {
